...
async function seedItem() {
  ...
  const itemsToInsert: ItemData[] = [
    ...
    { name: 'Grand Badge', description: 'Grand Badge avec une broche.', image: '2.jpg', size: '70mm', price: 1.5, quantity: 100, category: 'Badge', tags: 'Badge,Grand', isAvailable: 1, isCustomisable: 1 },
    { name: 'Porte-Clés', description: 'Porte-Clés.', image: '3.jpg', size: '56mm', price: 1, quantity: 100, category: 'Porte-Clés', tags: 'Porte-Clés,Miroir', isAvailable: 1, isCustomisable: 1 },
    { name: 'Porte-Clés miroir', description: 'Porte-Clés avec un petit miroir.', image: '4.jpg', size: '56mm', price: 2, quantity: 100, category: 'Porte-Clés', tags: 'Porte-Clés,components', isAvailable: 1, isCustomisable: 1 },
    { name: 'Petit Magnet', description: 'Petit Magnet.', image: '5.jpg', size: '56mm', price: 1, quantity: 100, category: 'Magnet', tags: 'Magnet,Petit', isAvailable: 1, isCustomisable: 1 },
    { name: 'Grand Magnet', description: 'Grand Magnet.', image: '6.jpg', size: '70mm', price: 1.5, quantity: 100, category: 'Magnet', tags: 'Magnet,Grand', isAvailable: 1, isCustomisable: 1 },
